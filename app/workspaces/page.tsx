  ...
  return (
    <div className="admin-shell min-h-screen">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between border-b px-4 sm:px-6">
        <span className="text-base font-semibold">Name Search</span>
        <ThemeSwitcher className="h-11 w-11 rounded-xl shadow-none hover:translate-y-0 hover:bg-muted" />
      </div>
      <PageFrame title="Your congregations" description="Choose a private workspace to continue with Name Search or Team Progress.">
        <WorkspacesList />
      </PageFrame>
    </div>
  )
