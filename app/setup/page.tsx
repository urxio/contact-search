...
export default function SetupPage(){
 ...
 return <main className="admin-shell flex min-h-screen items-center justify-center px-4"><section className="admin-material w-full max-w-md rounded-3xl p-8"><h1 className="text-2xl font-bold tracking-tight">Set up Search Helper</h1><p className="mb-6 mt-1 text-sm text-muted-foreground">Create the first platform owner. This page permanently closes afterward.</p><form onSubmit={submit} className="space-y-4">
